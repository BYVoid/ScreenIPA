...
namespace HookEx {
    internal static class KeyboardConstaint {
        ...
        internal static readonly short VK_PACKET = 0xE7;

        internal static readonly int KEYEVENTF_EXTENDEDKEY = 0x0001;
        internal static readonly int KEYEVENTF_KEYUP = 0x0002;
        internal static readonly int KEYEVENTF_UNICODE = 0x0004;
        internal static readonly int KEYEVENTF_SCANCODE = 0x0008;
